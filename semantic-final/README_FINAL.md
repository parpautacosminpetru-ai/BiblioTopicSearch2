...
Repository-ul păstrează proiectul în `BiblioTopicSearch_FINAL.zip`. Workflow-ul GitHub îl dezarhivează, injectează modelul semantic pinned în `app/src/main/assets/semantic/`, verifică SHA-256 pentru fișierele binare principale și rulează `:app:assembleDebug`.
